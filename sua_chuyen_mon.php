  ...
  <!-- /.sidebar -->
        ...
        <div class="content-wrapper">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">Sửa chuyên môn</li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
            ...
            <section class="content">
                ...
                if (isset($_GET['id'])) {
                    ...
                    $truyvan = "SELECT * FROM chuyen_mon WHERE id = '$id'";
                    $que = mysqli_query($conn, $truyvan);
                    $ketqua = mysqli_fetch_assoc($que);
                }
                ?>
                <form action="sua_chuyen_mon.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="col-md-12">
                            <div class="card card-outline card-info">
                                ...
                                <div class="card-body">
                                    ...
                                    <input type="text" class="form-control" id="exampleInputPassword1" value="<?php echo $ketqua['ma_chuyen_mon']   ?>" name="macm" readonly>
                                </div>
                                <div class="card-body">
                                    <label for="exampleInputPassword1">Tên chuyên môn </label>
                                    <input type="text" class="form-control" id="exampleInputPassword1" value="<?php echo $ketqua['ten_chuyen_mon']  ?>" name="tencm" required>
                                </div>
                                <div class="card-body">
                                ...
                                <?php 
                                    if ($_SESSION['level'] == 1){
                                         echo "<button type='submit' class='btn btn-warning' name='suachuyenmon'><i class='fa fa-edit'></i> Lưu lại</button>";
        ...
        if (isset($_POST['suachuyenmon'])) {
            ...
            if (!empty($tencm)) {
                ...
                $sql = "UPDATE chuyen_mon
                SET ten_chuyen_mon = '$tencm', 
                    ghi_chu = '$mota', 
                    nguoi_sua = '$nguoisua', 
                    ngay_sua = '$ngaysua' 
                WHERE id = '$id'";
                ...
                if (mysqli_query($conn, $sql)) {
                    ...
                    echo "<script>alert('Cập nhật chuyên môn thành công!'); window.location.href = 'them_chuyen_mon.php';</script>";
                } else {
