  ...
  <!-- /.sidebar -->
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                ...
                ?>
                <form action="sua_loai_kt.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="col-md-12">
                            <div class="card card-outline card-info">
                                <div class="card-header">
                                    <h3 class="card-title">
                                        Chỉnh sửa loại khen thưởng
                                    </h3>
                                </div>
                                <div class="card-body">
                                    <label for="exampleInputPassword1">Mã loại</label>
                                    <input type="text" class="form-control" id="exampleInputPassword1" value="<?php echo $ketqua['ma_loai']   ?>" name="makt" readonly>
                                </div>
                                <div class="card-body">
                                ...
                                <?php 
                                    if ($_SESSION['level'] == 1){
                                         echo "<button type='submit' class='btn btn-warning' name='sualoaikt'><i class='fa fa-edit'></i> Lưu lại</button>";
        ...
        if (isset($_POST['sualoaikt'])) {
            ...
            if (!empty($tenloai)) {
                ...
                if (mysqli_query($conn, $sql)) {
                    ...
                    echo "<script>alert('Cập nhật thành công!'); window.location.href = 'loai_kt_kl.php';</script>";
                } else {
