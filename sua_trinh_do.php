        ...
        <div class="content-wrapper">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">Sửa trình độ</li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
            ...
            <section class="content">
                ...
                if (isset($_GET['id'])) {
                    ...
                    $truyvan = "SELECT * FROM trinh_do WHERE id = '$id'";
                    $que = mysqli_query($conn, $truyvan);
                    $ketqua = mysqli_fetch_assoc($que);
                }
                ?>
                <form action="sua_trinh_do.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="col-md-12">
                            <div class="card card-outline card-info">
                                ...
                                <div class="card-body">
                                    ...
                                    <input type="text" class="form-control" id="exampleInputPassword1" value="<?php echo $ketqua['ma_trinh_do']   ?>" name="matd" readonly>
                                </div>
                                <div class="card-body">
                                    <label for="exampleInputPassword1">Tên trình độ </label>
                                    <input type="text" class="form-control" id="exampleInputPassword1" value="<?php echo $ketqua['ten_trinh_do']  ?>" name="tentd" required>
                                </div>
                                <div class="card-body">
                                ...
                                <?php 
                                    if ($_SESSION['level'] == 1){
                                         echo "<button type='submit' class='btn btn-warning' name='suatrinhdo'><i class='fa fa-edit'></i> Lưu lại</button>";
        ...
        if (isset($_POST['suatrinhdo'])) {
            ...
            if (!empty($tentd)) {
                ...
                if (mysqli_query($conn, $sql)) {
                    ...
                    echo "<script>alert('Cập nhật trình độ thành công!'); window.location.href = 'them_trinh_do.php';</script>";
                } else {
