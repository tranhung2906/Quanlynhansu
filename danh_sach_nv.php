...
$showData = "SELECT * FROM nhan_vien";
            ...
            <div class="row">
              <div class="col-lg-3 col-6">
                ...
                <div class="small-box bg-info">
                  ...
                  <?php
                  if ($_SESSION['level'] == 1) {
                    echo "<a href='add_staff.php' class='small-box-footer'>Thêm nhân viên <i class='fas fa-arrow-circle-right'></i></a>";
                  } else if ($_SESSION['level'] == 0) {
                    echo "<a  class='small-box-footer'>Thêm nhân viên <i class='fas fa-arrow-circle-right'></i></a>";
                  }
                  ?>
                </div>
              </div>
              <div class="col-lg-3 col-6">
                ...
                <div class="small-box bg-success">
                  ...
                  <?php
                  if ($_SESSION['level'] == 1) {
                    echo " <a href='excel/export_dsnv.php' class='small-box-footer'>Xuất ecxel danh sách nhân viên  <i class='fas fa-arrow-circle-right'></i></a>";
                  } else if ($_SESSION['level'] == 0) {
                    echo "<a class='small-box-footer'>Xuất ecxel danh sách nhân viên  <i class='fas fa-arrow-circle-right'></i></a>";
                  }
                  ?>
              ...
              <tr>
                ...
                <td><?php
                    if ($arrS['trang_thai'] == 1) {
                      echo "Đang làm việc";
                    } else if ($arrS['trang_thai'] == 0) {
                      echo "Đã nghỉ việc";
                    }
                    ?></td>
                <td style='width: 10px;'><a href="xem_nhan_vien.php?id=<?php echo $arrS[ 'id'] ?>"  class='btn bg-primary btn-flat' name='editaccount'"><i class='fa fa-eye'></i></a></td>
                                    <?php
                                    if ($_SESSION['level'] == 1) {
                                      echo "<td style='width: 10px;'><a href='edit_nhanvien.php?id=" . $arrS['id'] . "' class='btn bg-orange btn-flat' name='editaccount'><i class='fa fa-edit'></i></a></td>";
                                    } else if ($_SESSION['level'] == 0) {
                                    ...
                                    if ($_SESSION['level'] == 1) {
                                      echo "<td style='width: 10px;'><a href='xoa_nhan_vien.php?id=" . $arrS['id'] . "' class='btn bg-maroon btn-flat' name='xoa' onclick='return confirm(\"Bạn có chắc chắn muốn xóa nhân viên?\");'><i class='fa fa-trash'></i></a></td>";
                                    } else if ($_SESSION['level'] == 0) {
